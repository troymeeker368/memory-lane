...
import { getPartnerDetail, getReferralSourceDetail } from "@/lib/services/partner-detail-read-model";
import { getStaffDetail, getTimeReviewDetail } from "@/lib/services/staff-detail-read-model";
import { createClient } from "@/lib/supabase/server";
import type { AppRole } from "@/types/app";

export { getLeadDetail, getMemberDetail, getPartnerDetail, getReferralSourceDetail, getStaffDetail, getTimeReviewDetail };
