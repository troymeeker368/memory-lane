...
export const FIRST_DAY_WELCOME_LETTER_TEMPLATE = [
  ...
  "Copy of Insurance Cards (these can be uploaded in Memory Lane)",
  "Copy of POA or Guardianship documentation (if applicable, may also be uploaded in Memory Lane)",
