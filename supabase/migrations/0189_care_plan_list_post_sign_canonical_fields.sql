...
as $$
  ...
  base as (
    select
      ...
      cp.status,
      cp.completed_by,
      cp.caregiver_signature_status,
      cp.final_member_file_id,
    ...
    select coalesce(
      jsonb_agg(
        jsonb_build_object(
          ...
          'caregiver_signature_status', paged.caregiver_signature_status,
          'final_member_file_id', paged.final_member_file_id,
