drop function if exists public.rpc_get_sales_dashboard_summary(date);
...
drop function if exists public.rpc_get_sales_pipeline_summary_counts();
drop function if exists public.rpc_list_mar_member_options();
drop function if exists public.rpc_finalize_enrollment_packet_request_completion(
  uuid,
  text,
  timestamptz,
  timestamptz,
